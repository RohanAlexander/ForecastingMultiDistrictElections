...
summary_stats %>%
  kable(format = "latex", 
        ...
        digits = 2, 
        format.args = list(big.mark = ","),
        caption = "First preferences from the Smartvote Australia and Life in Australia datasets, by state",
        linesep = ""
        )  
# %>% 
#   kable_styling(font_size = 8)
...
SmartVote_summary_education <- tibble(Type = c("Education", "", "", "", ""),
                                      Class = c("High school", "Grad. dip.", "Bachelor", "Postgraduate", "Unknown"),
                                      Number = c("-", "-", "-", "-", "-"),
                                      Proportion = c("-", "-", "-", "-", "-"))
...
After cleaning and adjustment we have 58,972 responses. 
