...
## Account for features of the electoral system
...
\end{eqnarray} 
That is, we consider each division has a degree of 'inertia', whereby support for the Australian Labor Party in the previous election helps determine what we expect support for the Australian Labor Party to be this election.
